 ...
 * cancelSleepTimer/onSleepTimerTick) rather than a JS setInterval — see the
 * Kotlin side (NativeMusicPlayerModule) for what that buys over a plain JS
 * timer. This component just reflects whatever the native side reports.
 */
const SleepTimerSheet = forwardRef<SleepTimerSheetHandle, SleepTimerSheetProps>(({heightFraction = 0.3}, ref) => {
